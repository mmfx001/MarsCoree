    ...
    return (
        <div className="bg-slate-800 h-screen py-6 fixed z-10 mt-8 ">
            <ul>
                ...
                <li className="mb-2">
                    <Link to="/coins" className="text-white w-full font-semiboldbold hover:bg-orange-700 p-3 flex flex-col gap-2 items-center">
                ...
                <li>
                    <Link to="/talim" className="text-white w-full font-semiboldbold hover:bg-orange-700 p-3 flex flex-col gap-2 items-center">
                ...
                <li>
                    <Link to="/davomat" className="text-white w-full font-semiboldbold hover:bg-orange-700 p-3 flex flex-col gap-2 items-center">
                ...
                <li>
                    <Link to="/exam" className="text-white w-full font-semiboldbold hover:bg-orange-700 p-3 flex flex-col gap-2 items-center">
